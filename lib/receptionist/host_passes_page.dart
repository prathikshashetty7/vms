    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                print('Found ${passes.length} total passes');
                for (var doc in passes) {
                  final data = doc.data() as Map<String, dynamic>;
                  print('Pass: ${data['v_name']} - Department: ${data['departmentId']} - Generated by: ${data['pass_generated_by']}');
                }
                // Show all passes for now (no department filtering)
                final filteredPasses = passes.toList();
                print('Showing all ${passes.length} passes (no department filtering)');
                
                print('Total passes found: ${passes.length}');
                print('Department ID: $departmentId');
